...
const Login = () => {
  ...
  const handleLinkedInLogin = () => {
    toast({
      ...
      description: "LinkedIn authentication would be integrated here.",
    });
    navigate("/dashboard");
  };
  ...
  const handleTelegramConnect = () => {
    toast({
      title: "Telegram Bot",
      description: "Telegram bot integration would open here.",
    });
  };
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <Button variant="outline" className="w-full" onClick={handleTelegramConnect}>
              <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
